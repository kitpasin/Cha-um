...
import { BannerData } from "../../../../data/service/pruning&cutdown/BannerData";
import Aos from "aos";
...
export default function Banner({ host, banner }) {
  ...
  return (
    <>
      <div className="bg-[url('/images/service/pruning&cutdown/banner/dec-bg.png')] bg-[#618861] bg-cover bg-center px-4 py-12 text-[#fff] text-center">
