...
export default function GardenDetail({ host }) {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>{serviceDetail[0]?.title || "ออกแบบจัดสวน จัดประดับตกแต่งไม้ดอกไม้ประดับ"}</title>
        <meta
          name="description"
          content="เรามุ่งมั่นสร้างสรรค์ผลงานที่เป็นเลิศ"
          data-rh="true"
        />
        <link rel="canonical" href={`/service/garden/${serviceDetail[0]?.id}`} />
      </Helmet>
      {!loading ? (
