...
export default function CleaningDetail({ host }) {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>{serviceDetail[0]?.title || "จ้างเหมาทำความสะอาด และเก็บสิ่งแปลกปลอม"}</title>
        <meta
          name="description"
          content="เรามุ่งมั่นสร้างสรรค์ผลงานที่เป็นเลิศ"
          data-rh="true"
        />
        <link rel="canonical" href={`/service/cleaning/${serviceDetail[0]?.id}`} />
      </Helmet>
      {!loading ? (
            ...
            <div className="max-w-[1280px] grid xl:grid-cols-2 gap-4 m-auto md:mb-12">
              ...
              >
                ...
                <div className="flex flex-col gap-12 max-md:gap-4 max-xl:mt-14 max-md:mt-0 flex-none">
                  <div className="grid grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 items-start gap-4 text-[18px] xl:text-[22px]">
