...
import { BannerData } from "../../../../data/service/cleaning/BannerData";
import Aos from "aos";
...
export default function Banner() {
  ...
  return (
    <>
      <div className="bg-[url('/images/service/cleaning/banner/dec-bg.png')] bg-[#618861] bg-cover bg-center px-4 py-12 text-[#fff] text-center">
