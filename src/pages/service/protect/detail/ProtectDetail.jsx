...
export default function ProtectDetail({ host }) {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>{serviceDetail[0]?.title || "งานป้องกันอันตรายต่อการบิน"}</title>
        <meta
          name="description"
          content="เรามุ่งมั่นสร้างสรรค์ผลงานที่เป็นเลิศ"
          data-rh="true"
        />
        <link rel="canonical" href={`/service/protect/${serviceDetail[0]?.id}`} />
      </Helmet>
      {!loading ? (
