...
import { BannerData } from "../../../../data/etc/design/BannerData";
import Aos from "aos";
...
export default function Banner({ host, banner }) {
  ...
  return (
    <div>
      ...
      <div className="bg-[url('/images/etc/design/banner/dec-bg.png')] bg-[#618861] bg-cover bg-center px-4 py-12 text-[#fff] text-center">
