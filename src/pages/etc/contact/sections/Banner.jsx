...
import { BannerData } from "../../../../data/etc/contact/BannerData";
import Aos from "aos";
...
export default function Banner({ host, banner }) {
  ...
  return (
    <div>
      ...
      <div className="bg-[url('/images/etc/contact/banner/dec-bg.png')] bg-[#618861] bg-cover bg-center px-4 py-12 text-[#fff] text-center">
