  ...
  return (
    <div className="relative px-4 pt-12 pb-12 md:pb-24 xl:pb-36">
      ...
      <div className="max-w-[1280px] max-xl:max-w-[650px] flex flex-col gap-12 m-auto">
        ...
        <Link
          to="#"
          className="bg-[#004500] max-xl:bg-[#537A53] w-fit flex items-center gap-2 m-auto p-2 rounded-[5px] hover:scale-125 text-[#fff] text-[18px] z-10 transition-all ease-in-out duration-300"
        >
          More
          <AddRoundedIcon />
        </Link>
