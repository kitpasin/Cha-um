...
import { BannerData } from "../../../data/process/BannerData";
import Aos from "aos";
...
export default function Banner() {
  ...
  return (
    <div>
      ...
      <div className="bg-[url('/images/process/banner/dec-bg.png')] bg-[#618861] bg-cover bg-center px-4 py-12 text-[#fff] text-center">
